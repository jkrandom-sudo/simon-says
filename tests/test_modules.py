...
class TestI18n(unittest.TestCase):
    def test_translation_and_fallback(self):
        self.assertEqual(i18n.t("en", "title"), "Simon Says")
        self.assertEqual(i18n.t("zh", "title"), "西蒙说")
        self.assertEqual(i18n.t("missing", "title"), "Simon Says")
        self.assertEqual(i18n.t("en", "missing"), "missing")

    def test_formatting_error_returns_text(self):
        self.assertEqual(i18n.t("en", "correct"), "Correct! +{points}")
